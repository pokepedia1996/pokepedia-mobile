...
final _cardRow = <String, dynamic>{
  ...
  "category": "Pokemon",
  "image_url":
      "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/AC3a/006_205.webp",
  ...
  "details": <String, dynamic>{
    ...
    "attacks": [
      <String, dynamic>{
        ...
        "damage": null,
        "description":
            "Serangan ini hanya bisa digunakan jika Pokemon ini memiliki Token Kerusakan.",
        "energy_cost": ["Grass"],
      },
      <String, dynamic>{
    ...
    "pokedex": <String, dynamic>{"height": "1", "number": 15, "weight": "29.5"},
    "weakness": <String, dynamic>{"type": "Fire", "modifier": "x2"},
    "abilities": <dynamic>[],
    "card_type": "Grass",
    "resistance": null,
    "evolves_from": "Kakuna",
...
final _poolRows = [
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/AR/053_099.webp",
    ...
    "details": <String, dynamic>{
      ...
      "attacks": [
        <String, dynamic>{
          ...
          "damage": "10",
          "description":
              "If you played Beedrill from your hand during this turn, this attack's base damage is 40 instead of 10.",
          "energy_cost": ["Grass"],
        },
        <String, dynamic>{
          "name": "Fury Attack",
          ...
          "energy_cost": ["Grass", "Colorless", "Colorless"],
        },
      ],
      ...
      "weakness": <String, dynamic>{"type": "Fire", "modifier": "\u00d72"},
      "card_type": "Grass",
      "retreat_cost": 1,
  ...
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/CRI/003_086.webp",
  ...
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/DS/001_113.webp",
    ...
    "details": <String, dynamic>{
      ...
      "attacks": [
        <String, dynamic>{
          ...
          "energy_cost": ["Colorless", "Grass", "Metal"],
        },
      ],
      "pokedex": <String, dynamic>{
        "height": "1.0",
  ...
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/B2/047_130.webp",
  ...
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/G2/009_132.webp",
    ...
    "details": <String, dynamic>{
      ...
      "attacks": [
        ...
        <String, dynamic>{
          ...
          "energy_cost": ["Colorless", "Colorless", "Colorless"],
        },
      ],
      "pokedex": <String, dynamic>{
        "height": "1.0",
      ...
      "weakness": <String, dynamic>{"type": "Fire", "modifier": "\u00d72"},
      "card_type": "Grass",
      "resistance": <String, dynamic>{"type": "Fighting", "modifier": "-30"},
      "evolves_from": "Kakuna",
      "evolution_stage": "Stage 2",
    },
  },
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/G2/047_132.webp",
    "illustrator": "Ken Sugimori",
    "regulation_mark": null,
    "language": "en",
    "variant": "normal",
    "details": <String, dynamic>{
      ...
      "attacks": [
        <String, dynamic>{
          ...
          "description":
              "Flip a coin. If heads, the Defending Pok\u00e9mon is now Poisoned. It takes 20 Poison damage instead of 10 after each player's turn (even if it was already Poisoned).",
          "energy_cost": ["Grass"],
        },
      ],
      "pokedex": <String, dynamic>{
      ...
      "abilities": [
        <String, dynamic>{
          "name": "Emerge",
          "description":
              "Once during your turn (before your attack), you may flip a coin. If heads, search your deck for an Evolution card named Koga's Beedrill and put it on Koga's Kakuna. (This counts as evolving Koga's Kakuna.) Shuffle your deck afterward. This power can't be used if Koga's Kakuna is Asleep, Confused, or Paralyzed.",
          "ability_type": "Poke-POWER",
        },
      ],
      "card_type": "Grass",
  ...
  <String, dynamic>{
    ...
    "category": "Pokemon",
    "image_url":
        "https://pub-61ccf1b9e1ab4037b28e968ea11d9d1f.r2.dev/en/B2/100_130.webp",
...
void main() {
  testWidgets('CardInfoPanel renders a real card inside a ListView', (
    tester,
  ) async {
